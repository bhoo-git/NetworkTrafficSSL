...
def get_config():
    ...
    '''
    Training Configuration of FixMatch + Custom Transform for net_img data
    '''
    parser.add_argument('--net_img_transform', type=bool, default=False,
                        help='network_image-specific functional transforms')
...
def main(args):
    ...
    print(f'n_gpus_per_node: {ngpus_per_node}')
