...
def get_dataset(args, algorithm, dataset, num_labels, num_classes, data_dir='./data', include_lb_to_ulb=True):
    ...
    from semilearn.datasets import get_unsw, get_cicids # Add network traffic data (Edit: Robin Bhoo)
    ...
    if dataset == "eurosat":
        ...
        test_dset = None
    # network dataset (Edit: Robin Bhoo)
    elif dataset in ['unsw', 'unsw_img', 'unsw_img_balanced', 'unsw_tiny']:
        lb_dset, ulb_dset, eval_dset = get_unsw(args, algorithm, dataset, num_labels, num_classes, data_dir=data_dir, include_lb_to_ulb=include_lb_to_ulb)
        test_dset = None
    elif dataset in ['cicids', 'cicids_img', 'cicids_img_balanced', 'cicids_tiny']:
        lb_dset, ulb_dset, eval_dset = get_cicids(args, algorithm, dataset, num_labels, num_classes, data_dir=data_dir, include_lb_to_ulb=include_lb_to_ulb)
        test_dset = None
    # speech dataset
