...
def get_unsw(args, alg, name, num_labels:int, num_classes:int, data_dir='./data', include_lb_to_ulb=True):
    ...
    # Get UNSW data and split into training-testing data.
    ...
    if name in ['unsw_img', 'unsw_img_balanced', 'unsw_tiny']:
